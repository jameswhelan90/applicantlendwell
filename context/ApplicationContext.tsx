...
export const STEP_LABELS: Record<StepId, string> = {
  ...
  // Identity
  id_name: 'What is your name?',
  id_dob: 'When were you born?',
  id_contact: 'Contact details',
  id_nationality: 'Nationality and residency',
  id_ni_pps: 'NI / PPS number',
  id_address: 'Current address',
  id_address_history: 'Previous address',
  id_upload_photo: 'Upload Photo ID',
  // Household
  hh_circumstances: 'Personal circumstances',
  hh_application_mode: 'Application type',
  hh_second_applicant: 'Second applicant details',
  hh_second_applicant_contact: 'Second applicant contact',
  hh_upload_joint_id: 'Second applicant Photo ID',
  hh_dependants: 'Dependants',
  // Intent
  intent_type: 'Mortgage type',
  intent_remortgage: 'Current mortgage details',
  ...
  emp_self_employed: 'Self-employment details',
  emp_upload_payslips: 'Upload payslips',
  emp_upload_tax: 'Upload tax returns',
  emp_second_applicant: 'Second applicant employment',
  emp_upload_joint: 'Second applicant income evidence',
  // Income
  inc_salary: 'Your income',
  inc_additional: 'Additional income',
  inc_second_applicant: 'Second applicant income',
  inc_upload_bank: 'Upload bank statements',
  inc_upload_joint_bank: 'Second applicant bank statements',
  // Commitments
  commit_outgoings: 'Monthly commitments',
  ...
  // Documents
  docs_overview: 'Upload your documents',
  // Agreements
  ag_declarations: 'Declarations',
  ag_signature: 'Sign your application',
  // Completion
  completion: 'Ready to submit',
  // LEGACY labels (backwards compatibility)
  fp_name: 'What is your name?',
  fp_dob: 'When were you born?',
  fp_contact: 'Contact details',
  fp_circumstances: 'Personal circumstances',
  fp_address: 'Current address',
  fp_address_history: 'Address history',
  fp_employment_status: 'Employment status',
  fp_employment_details: 'Employment details',
  fp_income: 'Your income',
  fp_outgoings: 'Monthly commitments',
  fp_deposit: 'Deposit and savings',
  fp_goals: 'Mortgage goals',
